...
public class EndPoints {
    ...
    private static final String API_URL = "http://181.199.190.20/VanShopVhBackendPruebas2/api/list";    // staging
    ...
    public static final String CANCEL_PAYMENT           = API_URL.concat("/CancelPayment?userId=%d&id=%d");
    public static final String SHOPS                    = API_URL.concat("/GetShops");
    public static final String BANKS                    = API_URL.concat("/GetBanks?userId=%d");
    public static final String SHOPS_SINGLE             = API_URL.concat("/GetShops/%d");
    public static final String NAVIGATION_DRAWER        = API_URL.concat("/GetNavigations?userId=%d&shop=%d");
    public static final String BANNERS                  = API_URL.concat("/GetBanners?userId=%d");
    ...
    public static final String PRODUCTS                 = API_URL.concat("/GetProducts?userId=%d");
    public static final String PRODUCTS_SINGLE          = API_URL.concat("/GetProduct?userId=%d&id=%d");
    public static final String PRODUCTS_SINGLE_RELATED  = API_URL.concat("/GetProduct?userId=%d&id=%d&include=related");
    ...
    public static final String ORDERS_SINGLE            = API_URL.concat("/Order?userId=%d&id=%d");
    public static final String ORDERS_RECREATE          = API_URL.concat("/ReCreateOrder?orderId=%d");
    ...
    public static final String MAIN_MENU_BADGE_COUNT    = API_URL.concat("/GetMenuBadgeCount?userId=%d");
    public static final String INVOICE_HISTORY          = API_URL.concat("/GetInvoiceHistory?userId=%d");
